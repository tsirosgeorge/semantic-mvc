                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            <li class="nav-item">
                                ...
                                <ul class="nav collapse show" id="dashboard">
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'dashboard' ? 'active' : '' ?>" href="/softhouse/dashboard">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Αρχική</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'resellers' ? 'active' : '' ?>" href="/softhouse/resellers">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Μεταπωλητές</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'all-customers' ? 'active' : '' ?>" href="/softhouse/all-customers">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Όλοι οι πελάτες</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'unauthorized-customers' ? 'active' : '' ?>" href="/softhouse/unauthorized-customers">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Πελάτες χωρίς εξουσιοδότηση</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'customers-for-contract' ? 'active' : '' ?>" href="/softhouse/customers-for-contract">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Πελάτες για σύμβαση</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'signed-contracts' ? 'active' : '' ?>" href="/softhouse/signed-contracts">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Υπογεγραμμένες συμβάσσεις</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'customers-for-register' ? 'active' : '' ?>" href="/softhouse/customers-for-register">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Για εγγραφή</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'active-customers' ? 'active' : '' ?>" href="/softhouse/active-customers">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Ενεργοί</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>

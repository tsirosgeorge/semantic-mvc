                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            <li class="nav-item">
                                ...
                                <ul class="nav collapse show" id="dashboard">
                                    ...
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'unauthorized-customers' ? 'active' : '' ?>" href="/admin/unauthorized-customers">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Πελάτες χωρίς εξουσιοδότηση</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'customers-for-contract' ? 'active' : '' ?>" href="/admin/customers-for-contract">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Πελάτες για σύμβαση</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'signed-contracts' ? 'active' : '' ?>" href="/admin/signed-contracts">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Υπογεγραμμένες συμβάσσεις</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'customers-for-register' ? 'active' : '' ?>" href="/admin/customers-for-register">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Για εγγραφή</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link <?= $currentPage == 'active-customers' ? 'active' : '' ?>" href="/admin/active-customers">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                                    ...
                                    <a class="dropdown-item fw-bold" href="seminars"><span>Σεμινάρια</span></a>
